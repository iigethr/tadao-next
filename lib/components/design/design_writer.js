// Design - Design Writer

class DesignWriter extends React.Component {

  render () {
    return (
      <div className="design-content writer">
        <div className="design-content-box">
          <div className="design-content-row">
            <h1>Header 1 Tristique Egestas Tortor Bibendum Risus Dolor Sem Nullam Tortor Sollicitudin</h1>
            ...
            <div className="floater left">
              <div className="floater-box">
                <div className="floater-item center-h">
                  <figure>
                    <img src={require('../../../assets/images/512x512.png')} />
            ...
            <div className="floater left">
              <div className="floater-box">
                <div className="floater-item center-h">
                  <blockquote cite="https://tadao-next.now.sh/">
                    Etiam porta sem malesuada magna mollis euismod. Vestibulum id ligula porta felis euismod semper. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor.
                  </blockquote>
                </div>
              </div>
            </div>
            <p>Morbi leo risus, porta ac consectetur ac, vestibulum at eros. Nullam quis risus eget urna mollis ornare vel eu leo. <mark>Sed posu consectetur est at lobortis.</mark> Maecenas sed diam eget risus varius blandit sit amet non magna. Maecenas sed diam eget risus varius blandit sit amet non magna.
            Morbi leo risus, porta ac consectetur ac, vestibulum at eros. Nullam quis risus eget urna mollis ornare vel eu leo. <mark>Sed posu consectetur est at lobortis.</mark> <br /><br /><br />Maecenas sed diam eget risus varius blandit sit amet non magna. Maecenas sed diam eget risus varius blandit sit amet non magna.
            Morbi leo risus, porta ac consectetur ac, vestibulum at eros. Nullam quis risus eget urna mollis ornare vel eu leo. <mark>Sed posu consectetur est at lobortis.</mark> Maecenas sed diam eget risus varius blandit sit amet non magna. Maecenas sed diam eget risus varius blandit sit amet non magna.</p>
            <h5>Header 5</h5>
