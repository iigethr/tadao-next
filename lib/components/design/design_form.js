            ...
            <div className="form-group">
              ...
              <div className="form-item">
                <div className="checkbox">
                  ...
                  <label htmlFor="checkbox-1">Checkbox Item</label>
                </div>
              </div>
              <div className="form-item">
                <div className="checkbox">
                  <input type="checkbox" id="checkbox-2" />
                  <label htmlFor="checkbox-2">Checkbox Item</label>
                </div>
              </div>
              <div className="form-item">
                <div className="checkbox">
                  <input type="checkbox" id="checkbox-3" />
                  <label htmlFor="checkbox-3">Checkbox Item</label>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="form-group">
              ...
              <div className="form-item">
                <div className="radio">
                  ...
                  <label htmlFor="radio-1">Radio Item</label>
                </div>
              </div>
              <div className="form-item">
                <div className="radio">
                  <input type="radio" id="radio-2" />
                  <label htmlFor="radio-2">Radio Item</label>
                </div>
              </div>
              <div className="form-item">
                <div className="radio">
                  <input type="radio" id="radio-3" />
                  <label htmlFor="radio-3">Radio Item</label>
                </div>
              </div>
              <div className="form-item">
                <div className="radio">
                  <input type="radio" id="radio-4" />
                  <label htmlFor="radio-4">Radio Item</label>
                </div>
              </div>
              <div className="form-item">
                <div className="radio">
                  <input type="radio" id="radio-5" />
                  <label htmlFor="radio-5">Radio Item</label>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="form-menu">
            <div className="form-menu-box">
              <div className="form-menu-row">
                <a href="#" className="link-s">Link</a>
              </div>
              <div className="form-menu-row">
                <a href="#" className="link-s">Link</a>
              </div>
